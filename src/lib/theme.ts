...
// Controlador de tema (light/dark) para el iPhone Market.
//
// Reglas de negocio:
...
// - La elección del usuario se persiste en localStorage (ver siteConfig.theme.storageKey).
//
...
export const STORAGE_KEY = siteConfig.theme.storageKey
